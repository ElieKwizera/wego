...
import {login,googleSignIn} from '../store/actions/auth';
...
const Login = () => {
    ...
    const googleLogin =  (res)=>{
        ...
        dispatch(googleSignIn({username:userInfo.name,email:userInfo.email,history}));
    }

    const googleFail = async (error)=>{
        setShowError(true);
    }
    ...
    return (
        <div>
            ...
            <div className="flex flex-col w-full max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10 w-2/5 mx-auto mt-24">
                ...
                <div className="self-center mb-6 text-xl font-light text-primary font-bold dark:text-white">
                    On Demand Public Transport
                </div>

                <div className="self-center mb-5 text-md font-light text-gray-800 dark:text-white">
                    Login To Your Account
                </div>

                <div className="mt-10">
                    {showError && <p className={"text-red-600 text-center mx-auto mb-3"}> Error occurred while signing in. Please check your credentials</p>}
                    <form action="#" autoComplete="on" onSubmit={customLogin}>
                        ...
                        <div className="flex items-center mb-6 -mt-5">
                            <div className="flex ml-auto">
                                <Link to="/forgot" className="inline-flex text-xs font-thin text-gray-500 sm:text-sm hover:font-bolder">
                        ...
                        <div className="flex gap-4 item-center mt-5">
                            ...
                            <GoogleLogin
                                clientId="341857839779-ibatm53mmjelvdg0cmr3tau8gddpkv7u.apps.googleusercontent.com"
                                render={renderProps => (
                ...
                <div className="flex items-center justify-center mt-6">
                    <Link to="/register" className="inline-flex items-center text-sm font-thin text-center text-gray-500 hover:text-gray-700 dark:text-gray-100 dark:hover:text-white">
                        <span className="ml-2">
