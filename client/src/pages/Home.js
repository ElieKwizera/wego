...
import { getStatistics} from '../store/actions/dashboard';
    ...
    return (
        <div>
            <div className="container mx-auto p-10">
                <div className="flex flex-nowrap mx-auto space-x-5">
                    <div className="w-1/6">
                        <div className="shadow-lg rounded-2xl w-full p-4 bg-white">
                            <div className="flex items-center">
                                <p className="text-md text-gray-700 text-center"> Passengers </p>
                            </div>
                            <div className="flex flex-col justify-start">
                                <p className="text-gray-800 ml-2 text-3xl text-left font-bold my-4"> {dashboardData.stats.passengers} </p>
                                <p className="px-5 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-200 text-primary"> Total users </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-3/6">
                        <div className="shadow-lg rounded-2xl w-full p-4 bg-white">
                            <div className="flex items-center">
                                <p className="text-md text-gray-700 text-center"> Ride requests </p>
                            </div>

                            <div className="flex mx-auto space-x-5">
                                <div className="flex flex-col justify-start w-1/3">
                                    <p className="text-gray-800 ml-2 text-3xl text-left font-bold my-4">{dashboardData.stats.pendingRequests}</p>
                                    <p className="px-5 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800"> Pending requests </p>
                                </div>

                                <div className="flex flex-col justify-start w-1/3">
                                    <p className="text-gray-800 ml-2 text-3xl text-left font-bold my-4">{dashboardData.stats.approvedRequests} </p>
                                    <p className="px-5 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800"> Approved requests </p>
                                </div>

                                <div className="flex flex-col justify-start w-1/3">
                                    <p className="text-gray-800 ml-2 text-3xl text-left font-bold my-4"> {dashboardData.stats.declinedRequests} </p>
                                    <p className="px-5 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800"> Declined requests </p>
                                </div>
                            </div>
                    ...
                    <div className="w-1/6">
                        <div className="shadow-lg rounded-2xl w-full p-4 bg-white">
                            <div className="flex items-center">
                                <p className="text-md text-gray-700 text-center"> Locations </p>
                            </div>
                            <div className="flex flex-col justify-start">
                                <p className="text-gray-800 ml-2 text-3xl text-left font-bold my-4"> {dashboardData.stats.locations} </p>
                                <p className="px-5 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-200 text-primary"> Total pick-up locations </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-1/6">
                        <div className="shadow-lg rounded-2xl w-full p-4 bg-white">
                            <div className="flex items-center">
                                <p className="text-md text-gray-700 text-center"> Routes </p>
                            </div>
                            <div className="flex flex-col justify-start">
                                <p className="text-gray-800 ml-2 text-3xl text-left font-bold my-4"> {dashboardData.stats.routes} </p>
                                <p className="px-5 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-200 text-primary"> Registered routes </p>
                            </div>
                        </div>
                    </div>
                </div>

                <div className="flex mx-auto space-x-5 mt-10">
                    ...
                    <div className="w-3/12">
                        <div className="shadow-lg rounded-xl w-full md:w-80 p-4 bg-white relative overflow-hidden">
                            <div className="w-full flex items-center justify-between mb-8">
                                <p className="text-gray-800 dark:text-white text-xl font-normal"> Activity Tracker</p>
                                <Link to="#" className="flex items-center text-sm hover:text-gray-600 text-gray-300 border-0 focus:outline-none">
                                    VIEW ALL
                                </Link>
                            </div>
                            ...
                            <div className="flex items-start mb-6 rounded justify-between">
                                <div className="flex items-center w-full justify-between">
                                    <div className="flex text-sm flex-col w-full ml-2 items-start justify-between">
                                        ...
                                        Accepted a ride to Remera from Kacyiru
                                    </p>
                        ...
                        <div className="shadow-lg rounded-xl w-full md:w-80 p-4 bg-white relative overflow-hidden">
                            ...
                            <div className="flex items-center mb-6 rounded justify-between">
                                <span className="rounded-lg">
                                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40px" height="40px" viewBox="0 0 276.661 276.262" enableBackground="new 0 0 276.661 276.262" >
